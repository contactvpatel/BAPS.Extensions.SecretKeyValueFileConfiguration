...
namespace BAPS.Extensions.SecretKeyValueFileConfiguration
{
    ...
    /// </summary>
    public class SecretKeyValueFileConfigurationProvider : ConfigurationProvider, IDisposable
    {
        private readonly IDisposable? _changeTokenRegistration;

        SecretKeyValueFileConfigurationSource Source { get; set; }

        /// <summary>
        /// Initializes a new instance.
        /// </summary>
        /// <param name="source">The settings.</param>
        public SecretKeyValueFileConfigurationProvider(SecretKeyValueFileConfigurationSource source)
        {
        ...
        private void Load(bool reload)
        {
            ...
            foreach (var file in directory)
            {
                ...
                {
                    string[] lines = File.ReadAllLines(file.PhysicalPath);
