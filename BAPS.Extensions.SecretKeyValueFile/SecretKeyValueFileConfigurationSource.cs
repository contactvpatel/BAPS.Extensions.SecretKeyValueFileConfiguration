...
namespace BAPS.Extensions.SecretKeyValueFileConfiguration
{
    ...
    /// </summary>
    public class SecretKeyValueFileConfigurationSource : IConfigurationSource
    {
        /// <summary>
        /// Constructor;
        /// </summary>
        public SecretKeyValueFileConfigurationSource()
        ...
        /// <summary>
        /// Builds the <see cref="SecretKeyValueFileConfigurationProvider"/> for this source.
        /// </summary>
        /// <param name="builder">The <see cref="IConfigurationBuilder"/>.</param>
        /// <returns>A <see cref="SecretKeyValueFileConfigurationProvider"/></returns>
        public IConfigurationProvider Build(IConfigurationBuilder builder)
            => new SecretKeyValueFileConfigurationProvider(this);
    }
}
